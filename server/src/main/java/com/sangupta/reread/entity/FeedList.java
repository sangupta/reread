...
/**
 * Stores entire feed list for a given user as individual feeds as well as in
 * folders. Entity is written to DB.
 * 
 * @author sangupta
 *
 */
public class FeedList {
	...
	public UserFeedFolder getFolderForFeed(String feedID) {
		for (UserFeedFolder folder : this.folders) {
			if (folder.containsFeed(feedID)) {
				return folder;
			}
		}
